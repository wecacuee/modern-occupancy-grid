...
destination itself.
%A message over a directed edge can be understood as a \emph{belief} of the source node, which is itself the probability of a state of destination node marginalized over all neighbors of the source except the destination.
These messages are
