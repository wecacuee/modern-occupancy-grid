...
\begin{figure}
  \includegraphics[width=\columnwidth]{../figures/factorgraph/factorgraph2.pdf}
...
%To illustrate that we show the convergence of dual decomposition with different step size on \emph{cave} dataset in Fig.~\ref{fig:dualdecomposition-stepsize}. 
...
\begin{figure*}
  ...
  \subfloat[Convergence on cave dataset]{\includegraphics[width=0.30\textwidth]{../figures/relativeconvergence.pdf}}%
  \subfloat[Convergence on hospital section dataset]{\includegraphics[width=0.30\textwidth]{../../Data/hospital_section_player/plot-time-energy.pdf}}\\
  \subfloat[Convergence on hospital dataset]{\includegraphics[width=0.30\textwidth]{../../Data/hospital_player/plot-time-energy.pdf}}%
  \subfloat[Convergence on albert-b dataset]{\includegraphics[width=0.30\textwidth]{../figures/convergence-albert-b.pdf}}%
  \subfloat[Convergence with different step size in dual decomposition]{\includegraphics[width=0.30\textwidth]{../figures/dualdecomposition-stepsize-inc500.pdf}}
