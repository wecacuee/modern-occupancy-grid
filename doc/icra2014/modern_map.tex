...
\begin{figure*}
  ...
  \includegraphics[height=0.16\textwidth, trim=65px 126px 20px 175px, clip, angle=90]{../../Data/albertb.sm/SICKSlowMetropolis.png}%
...
\begin{figure*}
  ...
  \includegraphics[width=0.30\textwidth]{../../Data/cave_player/plot-time-energy.pdf}}%
  ...
  \includegraphics[width=0.30\textwidth]{../../Data/albertb.sm/plot-time-energy.pdf}}%
  \subfloat[Convergence with different step size in dual decomposition]{%
    \label{fig:dualdecomposition-stepsize}%
  \includegraphics[width=0.30\textwidth]{../../Data/plot-time-energy-step.pdf}}
